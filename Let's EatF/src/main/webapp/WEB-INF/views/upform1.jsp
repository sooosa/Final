...
<table>
	...
	<tr>
		...
		<input type="hidden" value="${sessionScope.cloginId}" name="scCode">
		</td>
	</tr>
	<tr>
		<td>영업시간</td>
	...
	<tr>
		<td>사업자 번호</td>
		<td><input type="text" name="sbNum" placeholder="사업자 번호를 입력하세요."></td>
	</tr>
	<tr>
		<td>주차 여부</td>
	...
	<tr>
		<td>키워드</td>
		<td><input type="text" name="keyword1" placeholder="1번 키워드를 입력하세요."><br>
		<input type="text" name="keyword2" placeholder="2번 키워드를 입력하세요."><br>
		<input type="text" name="keyword3" placeholder="3번 키워드를 입력하세요."><br>
		<input type="text" name="keyword4" placeholder="4번 키워드를 입력하세요."><br>
		<input type="text" name="keyword5" placeholder="5번 키워드를 입력하세요."></td>
	</tr>
	<tr>
			<td>외관 사진</td>
